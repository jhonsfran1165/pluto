/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8c22410d0f4a7d4d0ffe95e5463c1207)
// Runtime types generated with workerd@1.20250525.0 2025-03-19 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		FRONTEND_URL: string;
		FEED: DurableObjectNamespace<import("./src/index").FeedAgent>;
		USERDO: DurableObjectNamespace<import("./src/index").UserDO>;
		AGENTDO: DurableObjectNamespace<import("./src/index").AgentDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VERSION" | "JWT_SECRET" | "NODE_ENV" | "OPENROUTER_API_KEY" | "FRONTEND_URL">> {}
}
declare module "*.sql" {
	const value: string;
