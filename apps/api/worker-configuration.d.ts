/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0114a1e3196695b6813efd779106788a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VERSION" | "JWT_SECRET" | "NODE_ENV" | "OPENROUTER_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
